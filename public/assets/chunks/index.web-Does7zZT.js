import { g as getDefaultExportFromCjs, r as requireBn, a as requireElliptic, b as Buffer$1, $ as $hgUW1$crypto, c as getAugmentedNamespace, p as process$1, d as requireEvents } from "./index-C_zbkbH-.js";
...
$df64573ef6d51081$exports$1 = JSON.parse('{"name":"libnexa-ts","version":"1.0.7","description":"A pure and powerful Nexa SDK library.","type":"module","source":"src/index.ts","types":"dist/index.d.ts","main":"dist/index.cjs","module":"dist/index.mjs","browser":"dist/index.web.mjs","exports":{"types":"./dist/index.d.ts","node":{"import":"./dist/index.mjs","require":"./dist/index.cjs"},"browser":"./dist/index.web.mjs","default":"./dist/index.mjs"},"targets":{"main":{"context":"node","outputFormat":"commonjs","distDir":"dist","isLibrary":true,"includeNodeModules":["lodash-es"]},"module":{"context":"node","outputFormat":"esmodule","distDir":"dist","isLibrary":true},"browser":{"context":"browser","outputFormat":"esmodule","distDir":"dist","isLibrary":true}},"files":["dist"],"scripts":{"check":"tsc --noEmit && npm run madge","build":"del-cli ./dist && parcel build","lint":"eslint .","madge":"madge --circular src/index.ts","test":"vitest run --dir tests","coverage":"del-cli ./coverage && npm test -- --coverage --reporter=verbose --reporter=junit","docs":"typedoc"},"keywords":["nexa","blockchain"],"repository":{"type":"git","url":"https://gitlab.com/nexa/libnexa-ts"},"author":"vgrunner","license":"MIT","dependencies":{"bn.js":"^5.2.2","bs58":"^6.0.0","elliptic":"^6.6.1","js-big-decimal":"^2.2.0","lodash-es":"^4.17.21"},"devDependencies":{"@parcel/packager-ts":"^2.15.4","@parcel/transformer-typescript-types":"^2.15.4","@types/bn.js":"^5.2.0","@types/elliptic":"^6.4.18","@types/lodash-es":"^4.17.12","@types/node":"^24.5.1","@vitest/coverage-v8":"^3.2.4","del-cli":"^6.0.0","eslint":"^9.35.0","madge":"^8.0.0","parcel":"^2.15.4","typedoc":"^0.28.13","typedoc-plugin-markdown":"^4.8.1","typedoc-plugin-rename-defaults":"^0.7.3","typescript":"^5.9.2","typescript-eslint":"^8.44.0","vitest":"^3.0.6"},"@parcel/resolver-default":{"packageExports":true},"madge":{"detectiveOptions":{"ts":{"skipTypeImports":true}}}}');
...
class $90f45db77a786f2b$export$2e2bcd8739ae039 {
  ...
  */
  replaceChunk(index, replacement) {
    if (index < 0 || index >= this.chunks.length) return false;
  ...
  */
  ...
  isPlaceholderChunk(chunk) {
    if (!$9f918c10ad4fef51$export$2e2bcd8739ae039.isBuffer(chunk.buf) || chunk.buf.length < 64 || chunk.buf.length > 68) return false;
    return chunk.buf.subarray(0, 64).equals(Buffer$1.alloc(64));
  }
  /**
  * Check if the script is considered empty.
  *
  * Empty if:
  * - no chunks at all, OR
  * - a single 64-byte zero placeholder.
  * 
  *  @returns `true` if the script is semantically empty, otherwise `false`.
  */
  isEmpty() {
    return this.chunks.length === 0 || this.chunks.length === 1 && this.chunks[0].buf?.equals(Buffer$1.alloc(64)) === true;
  }
  /**
  ...
  */
  getVisibleArgs() {
    $e44f707fde477092$export$2e2bcd8739ae039.validateState(this.isScriptTemplateOut(), "Can't retrieve Visible Args from a non-PST output");
    return this.chunks[0].opcodenum !== $92c0719d4ab9ac45$export$393941f88fd16991.OP_0 ? new $90f45db77a786f2b$export$2e2bcd8739ae039({
      chunks: this.chunks.slice(4)
    }) : new $90f45db77a786f2b$export$2e2bcd8739ae039({
      chunks: this.chunks.slice(3)
    });
  }
  /**
...
class $2dc9a1945ba915b1$export$2e2bcd8739ae039 {
  ...
  */
  static buildTxSignature(transaction, inputNumber, sighashType, privateKey) {
...
class $bd99faf64de54a2c$export$2e2bcd8739ae039 {
  ...
  */
  signInput(input, privateKey, sigtype) {
    ...
    let txSig = $2dc9a1945ba915b1$export$2e2bcd8739ae039.buildTxSignature(this.transaction, input, sigtype, privateKey);
  ...
  _getSignatures(privKey, sigtype) {
    ...
    for (let i = 0; i < this.transaction.inputs.length; i++) {
      ...
      let txSig = $2dc9a1945ba915b1$export$2e2bcd8739ae039.buildTxSignature(this.transaction, i, sigtype, privKey);
...
function $59b5736a17e7320d$export$e240c810a53c3a0c(perms) {
  ...
  for (let perm of perms) switch (perm) {
    case "authorise":
      newFlags |= $a0743653d736276e$export$2e2bcd8739ae039.authFlags.BATON;
      break;
    case "mint":
      newFlags |= $a0743653d736276e$export$2e2bcd8739ae039.authFlags.MINT;
      break;
    case "melt":
      newFlags |= $a0743653d736276e$export$2e2bcd8739ae039.authFlags.MELT;
      break;
    case "rescript":
      newFlags |= $a0743653d736276e$export$2e2bcd8739ae039.authFlags.RESCRIPT;
      break;
    case "subgroup":
      newFlags |= $a0743653d736276e$export$2e2bcd8739ae039.authFlags.SUBGROUP;
      break;
  }
  return newFlags;
}
...
async function $3e8a638e2275dab4$export$661377a8795b235c(txBuilder, keys, token, amount, parentToken) {
  const privateKeys = [];
  const allKeys = $441c371114e3ba96$export$94f569bf4eb0f6f6.getAllKeys(keys);
  const authTokenId = parentToken || token;
...
async function $3e8a638e2275dab4$export$fa4f8ab25a7e8138(txBuilder, keys, token, perms, toAddr) {
  let allKeys = $441c371114e3ba96$export$94f569bf4eb0f6f6.getAllKeys(keys);
  let requiredPerms = new Set(perms);
  requiredPerms.add("authorise");
  for (let key of allKeys) {
    let utxos = await $884ce55f1db7e177$export$eaa49f0478d81b9d.getTokenUtxos(key.address, token);
    for (let utxo of utxos) {
      if (utxo.token_amount > 0) continue;
      let hasAllPerms = true;
      for (let perm of requiredPerms) if (!$59b5736a17e7320d$export$7f7cffd29bf2d96d(utxo.token_amount, perm)) {
        hasAllPerms = false;
        break;
      }
      ...
      txBuilder.to(toAddr, $926e193f4c554367$export$2e2bcd8739ae039.DUST_AMOUNT, token, BigInt(utxo.token_amount));
      return [
        key.key.privateKey
      ];
    }
  }
  throw new Error(`The required authority with permissions [${perms.join(", ")}] not found for token ${token}`);
}
async function $3e8a638e2275dab4$export$28a843ca046a6b3f(txBuilder, keys, token, perms, toAddr) {
  ...
  for (let key of allKeys) {
    ...
    for (let utxo of utxos) {
      ...
      const receiveAddress = toAddr ?? (keys.changeKeys.length > 0 ? keys.changeKeys[keys.changeKeys.length - 1].address : keys.receiveKeys[keys.receiveKeys.length - 1].address);
      txBuilder.to(keys.changeKeys.length > 0 ? keys.changeKeys[keys.changeKeys.length - 1].address : keys.receiveKeys[keys.receiveKeys.length - 1].address, $926e193f4c554367$export$2e2bcd8739ae039.DUST_AMOUNT, token, $59b5736a17e7320d$export$636fb0b03b94ac81(utxo.token_amount));
      if (reqiredPerms.size === 0) {
        txBuilder.to(receiveAddress, $926e193f4c554367$export$2e2bcd8739ae039.DUST_AMOUNT, token, $59b5736a17e7320d$export$e240c810a53c3a0c(perms));
        return usedKeys;
      }
    }
  }
          ...
          if (scriptPubkey.isScriptTemplateOut()) {
            ...
            newTxBuilder.transaction.addInput(new (0, $6995bc57838749e2$export$2e2bcd8739ae039)({
              ...
              templateData: {
                ...
                constraintScript: (0, $9f918c10ad4fef51$export$2e2bcd8739ae039).isHashBuffer(scriptPubkey.getConstraintHash()) ? (0, $90f45db77a786f2b$export$2e2bcd8739ae039).fromBuffer(scriptSig.chunks[1].buf) : void 0
              },
              output: {
                type: input.type,
                value: utxo.amount,
...
class $d71d9063d6876a10$export$2e2bcd8739ae039 extends $329d65a0aed426f1$export$bba690fb5c12ba04 {
  ...
  sendAuthority(token, perms, toAddr) {
    this.builder.push(async () => {
      if (!$6f559318d8845d29$export$8d986bd2866fe6ab(toAddr, this.network) && !$6f559318d8845d29$export$8d986bd2866fe6ab(toAddr, this.network, $c889a5b1bdeeb100$export$189c6ba3eaa96ac2.PayToPublicKeyHash)) throw new Error("Invalid Address.");
      const tokenAction = {
        token,
        action: "sendAuthority",
        amount: 0n,
        extraData: {
          perms,
          address: toAddr
  ...
  populate() {
    ...
    this.builder.push(async () => {
      ...
      if (this.tokens.size > 0) for (const tokenAction of this.tokens) {
        ...
        else if (tokenAction.action == "melt") tK = tK.concat(await $3e8a638e2275dab4$export$661377a8795b235c(this.transactionBuilder, this._account.accountKeys, tokenAction.token, tokenAction.amount, tokenAction.parentToken));
        ...
        else if (tokenAction.action == "sendAuthority") tK = tK.concat(await $3e8a638e2275dab4$export$fa4f8ab25a7e8138(this.transactionBuilder, this._account.accountKeys, tokenAction.token, tokenAction.extraData.perms, tokenAction.extraData.address));
...
async function $c03143e0cae56add$export$cfda880a425a2203(txBuilder, addresses, token, amount, parentToken) {
  const usedAddresses = [];
  const authTokenId = parentToken || token;
  let meltAuthorityFound = false;
  for (let item of addresses) {
...
async function $c03143e0cae56add$export$4445fa79afef5d0c(txBuilder, addresses, token, perms, toAddr) {
  let requiredPerms = new Set(perms);
  requiredPerms.add("authorise");
  for (let item of addresses) {
    let utxos = await $884ce55f1db7e177$export$eaa49f0478d81b9d.getTokenUtxos(item.address, token);
...
async function $c03143e0cae56add$export$5c44e04d8c04c292(txBuilder, addresses, token, perms, toAddr) {
  ...
  for (let item of addresses) {
    ...
    for (let utxo of utxos) {
      ...
      usedAddresses.push(item.address);
      txBuilder.to(item.address, $926e193f4c554367$export$2e2bcd8739ae039.DUST_AMOUNT, token, $59b5736a17e7320d$export$636fb0b03b94ac81(utxo.token_amount));
      if (reqiredPerms.size === 0) {
        txBuilder.to(toAddr ?? item.address, $926e193f4c554367$export$2e2bcd8739ae039.DUST_AMOUNT, token, $59b5736a17e7320d$export$e240c810a53c3a0c(perms));
        return usedAddresses;
      }
    }
  }
    ...
    this.builder.push(async () => {
      ...
      if (this.tokens.size > 0) for (const tokenAction of this.tokens) {
        if (tokenAction.action == "mint")
          ...
          tokenAddresses = tokenAddresses.concat(await $c03143e0cae56add$export$cfda880a425a2203(this.transactionBuilder, this._availableAddresses, tokenAction.token, tokenAction.amount, tokenAction.parentToken));
        ...
        else if (tokenAction.action == "sendAuthority")
          tokenAddresses = tokenAddresses.concat(await $c03143e0cae56add$export$4445fa79afef5d0c(this.transactionBuilder, this._availableAddresses, tokenAction.token, tokenAction.extraData.perms, tokenAction.extraData.address));
...
class $d3558bc9d24bb18b$export$2e2bcd8739ae039 {
   ...
   * @param addressToWatch The addresses to monitor
   * @param network Optional network name (defaults to mainnet)
   * @throws Error if validation fails
   */
  constructor(addressToWatch, network) {
    ...
    this._network = $149c1bd638913645$export$2e8191f482a38ccd.get(network) ?? $149c1bd638913645$export$2e8191f482a38ccd.mainnet;
    this._addressToWatch = this.validateAddressToWatch(addressToWatch);
  }
  /**
   * Validates the address to watch
   * @param addressToWatch The address to validate
   * @returns Validated array of WatchOnlyAddress objects
   * @throws Error if validation fails
   */
  validateAddressToWatch(addressToWatch) {
    if (addressToWatch === null || addressToWatch === void 0) throw new Error("addresesToWatch is required");
    const addr = addressToWatch;
    if (!isObject$1(addr) || isArray(addr)) throw new Error(`addressToWatch must be an object`);
    if (!addr.hasOwnProperty("address") || !isString(addr.address)) throw new Error(`addressToWatch.address must be a string`);
    if (addr.address.trim() === "") throw new Error(`addressToWatch.address cannot be empty`);
    if (!$6f559318d8845d29$export$8d986bd2866fe6ab(addr.address, this._network)) throw new Error(`addressToWatch.address is not a valid NEXA address: ${addr.address}`);
    if (addr.xPub !== void 0 && !isObject$1(addr.xPub)) throw new Error(`addressToWatch.xPub must be a PublicKey object`);
    if (addr.derivationPath !== void 0 && !isString(addr.derivationPath)) throw new Error(`addressToWatch.derivationPath must be a string`);
  ...
  newTransaction(x) {
    ...
    return tx.from(this._addressToWatch).onNetwork(this._network);
  }
  /**
  ...
  async subscribeToAddressNotifications(callback) {
    await $884ce55f1db7e177$export$eaa49f0478d81b9d.subscribeToAddresses([
      this._addressToWatch.address
    ], callback);
  }
  /**
   * Unsubscribe from address notifications to prevent memory leaks
   *
   * This method stops listening for notifications on the watched address.
  ...
  async unsubscribeFromAddressNotifications(callback) {
    await $884ce55f1db7e177$export$eaa49f0478d81b9d.unsubscribeFromAddresses([
      this._addressToWatch.address
    ], callback);
  }
  /**
   * Gets the address being watched
   * @returns The addresses being watched (copy to prevent mutation)
   */
  getWatchedAddress() {
    return this._addressToWatch;
  }
  /**
   * Gets the balance for the watched address
   * @returns Promise resolving to the balance object with confirmed and unconfirmed amounts
   */
  async getBalance() {
    return await $884ce55f1db7e177$export$eaa49f0478d81b9d.getBalance(this._addressToWatch.address);
  }
  /**
   * Gets token balances for the watched address
   * @returns Promise resolving to a record of token group IDs to balances
   */
  async getTokenBalances() {
    const tokensBalance = await $884ce55f1db7e177$export$eaa49f0478d81b9d.getTokensBalance(this._addressToWatch.address);
    const balance = {};
    const allTokenIds = /* @__PURE__ */ new Set([
      ...Object.keys(tokensBalance.confirmed),
      ...Object.keys(tokensBalance.unconfirmed)
...
//# sourceMappingURL=index.web-Does7zZT.js.map
