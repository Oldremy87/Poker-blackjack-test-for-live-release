...
class $770bd20b531dfe71$export$2e2bcd8739ae039 {
  ...
  async connect(timeout) {
    ...
    if (this.ws.readyState === ws.OPEN) return true;
  ...
  async notify(method, params, encrypted = true) {
    let payload = {
      jsonrpc: "2.0",
      method,
      params
    ...
    let raw = JSON.stringify(payload);
    let msg = encrypted ? await $1dee54fbcb867378$export$2e2bcd8739ae039.encrypt(raw, this.secret) : raw;
    this.send(msg);
  }
  on(method, handler) {
...
class $69598d18f252c5a5$export$2e2bcd8739ae039 {
  ...
  * @param params - The RPC method parameters.
  */
  sendNotification(method, params, encrypted = true) {
    return this.client.notify(method, params, encrypted);
  }
  /**
  ...
  */
  ...
  /**
  * Registers a handler for when the session deleted.
  * 
  * @param handler - The function to handle the session delete.
  */
  onSessionDelete(handler) {
    this.on("wl_sessionDeleted", () => {
      this.sessionId = "";
      handler();
    });
  }
  ...
  */
  ...
  /**
  * Terminated the relay session.
  */
  revokeSession() {
    return this.sendNotification("wl_revokeSession", [], false);
  }
}
class $fe6ed033804c8bce$export$2e2bcd8739ae039 extends $69598d18f252c5a5$export$2e2bcd8739ae039 {
  ...
  */
  ...
  /**
  * Retrieves the dApp info from the session.
  * 
  ...
  * @throws If the request fails or no app info is received.
  */
  async getAppInfo(timeoutMs = 1e4) {
  ...
  /**
  * Join a session and nofity the dApp that the wallet has joined.
  * 
...
class $ff9d81fc068ff3b6$export$2e2bcd8739ae039 extends $69598d18f252c5a5$export$2e2bcd8739ae039 {
  ...
  * @param secret - The session secret. Default is new generated secret.
  * @param sessionId - The protocol version. Default is empty string.
  */
  constructor(relayUrl, appInfo, version = "1", secret = $1dee54fbcb867378$export$2e2bcd8739ae039.generateSecret(), sessionId = "") {
    super(version, relayUrl, secret, sessionId), this.appInfo = appInfo;
    this.on("wl_sessionJoined", (address) => this.handleWalletJoined(address));
  }
  /**
  ...
  * @throws If the session creation fails.
  */
  async createSession(timeoutMs = 1e4) {
  ...
  * 
  * @param timeoutMs - The request timeout in milliseconds. Default 10_000ms
  * @returns A promise that resolves to true if joined successfully.
  * @throws If the operation fails.
  */
  async rejoinSession(timeoutMs = 1e4) {
    let success = await this.sendRequest("wl_joinSession", [
      this.sessionId,
      "app"
    ], {
  ...
  */
  waitForWallet(timeoutMs = 3e4) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const cleanup = () => {
        clearTimeout(timer);
        this.walletWaiterHandler = void 0;
        this.walletWaiterAbortController = void 0;
      };
      this.walletWaiterHandler = handler;
  ...
  */
  ...
  /**
  * Registers a handler for when a wallet joins the session.
  *
  * @param handler - The function to handle the wallet join event.
  */
  onWalletJoin(handler) {
    this.walletJoinedHandler = handler;
  }
  handleWalletJoined(address) {
    if (this.walletWaiterHandler) this.walletWaiterHandler(address);
    else if (this.walletJoinedHandler) this.walletJoinedHandler(address);
  }
  /**
  ...
  */
  signMessage(account, message, timeoutMs = 3e4, signal) {
  ...
  * @throws If the wallet is not connected or the request fails.
  */
  getAccount(timeoutMs = 3e4, signal) {
    if (!this.sessionId) throw new Error("Not connected to a wallet");
  ...
  * @throws If the wallet is not connected or the request fails.
  */
  addToken(account, token, timeoutMs = 3e4, signal) {
    if (!this.sessionId) throw new Error("Not connected to a wallet");
  ...
  * @throws If the wallet is not connected or the request fails.
  */
  signTransaction(account, hex, broadcast, timeoutMs = 3e4, signal) {
    if (!this.sessionId) throw new Error("Not connected to a wallet");
  ...
  * @throws If the wallet is not connected or the request fails.
  */
  sendTransaction(from, to, data, timeoutMs = 3e4, signal) {
    if (!this.sessionId) throw new Error("Not connected to a wallet");
  ...
  * @throws If the wallet is not connected or the request fails.
  */
  switchNetwork(network, timeoutMs = 3e4, signal) {
    if (!this.sessionId) throw new Error("Not connected to a wallet");
...
export {
  ...
  $abb7f0d6cff128a3$export$67bbc29c133d62a1 as JsonRpcError,
  $abb7f0d6cff128a3$export$4baa4fd50b453ebf as JsonRpcErrorCode,
...
//# sourceMappingURL=index.web-BVpTD3m9.js.map
